...
import { AI_IMAGE_SYMBOL, TOKEN_MINT } from '@/shared/constants';
import {
    getMintAiImageNftErrorAlert,
    getMintAImageNftAlert,
} from '@/shared/alerts';
import { SavedAiImageType } from '@/shared/types';
import { getNftMintData } from '@/shared/helpers/get-nft-mint-data';
import { mintAuthoritySeed, savedAiImageSeed } from '@/shared/seeds';
import { HandleSaveAiImageArgsType } from '@/features/save-ai-image/model';

export type MintAiImageNftArgsType = HandleSaveAiImageArgsType & {
    isFormChanged: boolean;
    savedAiImage: SavedAiImageType | null;
    connection?: web3.Connection;
};

export const mintAiImageNft = async ({
    publicKey,
    program,
    name,
    toast,
